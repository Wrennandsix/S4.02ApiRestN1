package cat.itacademy.barcelonactiva.SanchezMoreno.Marc.s04.t02.n01.controllers;
...
import cat.itacademy.barcelonactiva.SanchezMoreno.Marc.s04.t02.n01.modelServices.FruitServices;
...
public class FruitController {
	...
	public ResponseEntity<String> updateFruit(@PathVariable int id, @RequestBody Fruit newFruit) {
		...
		if (presentFruit.isPresent()) {
			...
			return new ResponseEntity<>("fruit with id:"+id+", does not exist in our database",HttpStatus.OK);
		}
